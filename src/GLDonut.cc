...
//********************************************************************
// Default Constructor
// Post-Condition -- Initializes the origin values of the Donut to
...
// Post-Condition -- Defines the origin values of the Donut
//					 that we are drawing. In the initial coordinates
//					 given, the origin is 0, 0, 0. We use this new
//					 origin value to draw the same Donut, and
...
// Post-Condition -- Uses the RotatePoints and drawGLDonut
